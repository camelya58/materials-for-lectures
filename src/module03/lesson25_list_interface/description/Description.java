 ...
 *
 * 7. Iterator
 *  "Повторитель", используется для того,  чтобы перебрать все элементы коллекции (единожды)
 ...
 * каждый раз начинается перебор с головы листа, пока по ссылкам не дойдет до нужного элемента или с хвоста, если так ближе.
 * по такому же принципу метод indexOf(Object);
 *
 * 8.2. Когда следует использовать:
 * - невелико количество операций по получению элементов по индексу;
